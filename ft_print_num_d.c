...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/06/05 08:08:30 by mmacheke          #+#    #+#             */
/*   Updated: 2016/06/05 08:08:37 by mmacheke         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_print_num_d(t_list_p *list, void *params)
{
	...
	num = ft_drill_2_ft_print_num_d(list, params);
	i = 0;
	if ((!num) && (list->dize))
		i = write(1, "0", 1);
	tmp2 = list->modifi_atoi;
	if (num < 0)
		return (ft_drill_2_ft_print_num_d_nega(num, list));
